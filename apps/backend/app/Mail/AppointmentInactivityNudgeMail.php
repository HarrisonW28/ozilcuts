...
class AppointmentInactivityNudgeMail extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: "We miss you — time for a fresh cut? — {$brand}",
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.appointments.inactivity_nudge',
            text: 'emails.appointments.inactivity_nudge_text',
            with: [
