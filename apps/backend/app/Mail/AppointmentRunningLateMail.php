...
class AppointmentRunningLateMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Content(
            markdown: 'emails.appointments.running_late',
            text: 'emails.appointments.running_late_text',
            with: [
